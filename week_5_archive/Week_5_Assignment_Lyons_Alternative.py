...
# Customize Matplotlib with 'Rolling Stone' gray (#76787B) for text, axes,
# xtick, and ytick
# Resources:
...
ax1.set_yticklabels([])
# ax2 plot
# A for loop collects colors in 'col' list based on the value
...
plt.show()
plot1_filename = 'week_5_matplotlib_lyons_1.png'
...
plt.show()
plot2_filename = 'week_5_matplotlib_lyons_2.png'
fig.savefig(plot2_filename, dpi=dpi)

# Create the second Matplotlib visual (first alternative)
# References:
...
width = 0.50
# Sum of the age category totals
age_sum = age_under_18_array+age_18_to_24_array+age_above_24_array
# Establish values for 100%
age_under_18_percent = age_under_18_array/age_sum*100.
age_18_to_24_percent = age_18_to_24_array/age_sum*100.
age_above_24_percent = age_above_24_array/age_sum*100.
fig, ax = plt.subplots(figsize=(10,5))
# https://matplotlib.org/stable/api/_as_gen/matplotlib.axes.Axes.set_title.html
ax.set_title('U.S. Overall Homeless By Age Group 2013-2020', loc='left')
# Create vertical 100% stack bars
rect1 = ax.bar(years, age_under_18_percent, width, color='#174A7E', label='Under 18')
rect2 = ax.bar(years, age_18_to_24_percent, width, color='#BFBEBE', bottom=age_under_18_percent, label='18 to 24')
rect3 = ax.bar(years, age_above_24_percent, width, color='#C3514E', bottom=age_under_18_percent+age_18_to_24_percent, label='Over 24')
# https://matplotlib.org/stable/api/_as_gen/matplotlib.axes.Axes.set_yticks.html
ax.set_yticks([])
# https://matplotlib.org/stable/api/_as_gen/matplotlib.axes.Axes.set_yticklabels.html
ax.set_yticklabels([])
...
for val, xpos, ypos, yval in zip(age_under_18, years, age_under_18_percent/2, age_under_18_percent):
    plt.text(xpos, ypos, val, color='white', ha="center", va="center")
for val, xpos, ypos, yval in zip(age_18_to_24, years, age_under_18_percent+age_18_to_24_percent/2, age_18_to_24_percent):
    plt.text(xpos, ypos, val, color='white', ha="center", va="center")
for val, xpos, ypos, yval in zip(age_above_24, years, age_under_18_percent+age_18_to_24_percent+age_above_24_percent/2, age_above_24_percent):
    plt.text(xpos, ypos, val, color='white', ha="center", va="center")
fig.tight_layout()
plt.show()
plot2a_filename = 'week_5_matplotlib_lyons_2a.png'
fig.savefig(plot2a_filename, dpi=dpi)
...
ax.legend(ncol=len(category_names), bbox_to_anchor=(0,1.015),
          loc='upper left', fontsize='small', frameon=False)
# Add text annotation of the values for each age category
for val, xpos, ypos, yval in zip(age_under_18, years, age_under_18_array/2, age_under_18_array):
    plt.text(xpos, ypos, val, color='white', ha="center", va="center")
for val, xpos, ypos, yval in zip(age_18_to_24, years, age_under_18_array+age_18_to_24_array/2, age_18_to_24_array):
    plt.text(xpos, ypos, val, color='white', ha="center", va="center")
for val, xpos, ypos, yval in zip(age_above_24, years, age_18_to_24_array+age_18_to_24_array+age_above_24_array/2, age_above_24_array):
    plt.text(xpos, ypos, val, color='white', ha="center", va="center")
fig.tight_layout()
plt.show()
plot2b_filename = 'week_5_matplotlib_lyons_2b.png'
...
fig.tight_layout()
plt.show()
plot3_filename = 'week_5_matplotlib_lyons_3.png'
