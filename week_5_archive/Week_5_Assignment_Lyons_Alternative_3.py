...
plt.show()
plot1_filename = 'week_5_matplotlib_lyons_1_11JUN21.png'
...
plt.show()
plot2_filename = 'week_5_matplotlib_lyons_2_11JUN21.png'
...
for val, xpos, ypos, yval in zip(age_under_18_fmt, years, age_under_18_percent/2, age_under_18_percent):
    ax.text(xpos, ypos, val, color='white', ha="center", va="center")
for val, xpos, ypos, yval in zip(age_18_to_24_fmt, years, age_under_18_percent+age_18_to_24_percent/2, age_18_to_24_percent):
    ax.text(xpos, ypos, val, color='black', ha="center", va="center")
for val, xpos, ypos, yval in zip(age_above_24_fmt, years, age_under_18_percent+age_18_to_24_percent+age_above_24_percent/2, age_above_24_percent):
    ax.text(xpos, ypos, val, color='black', ha="center", va="center")
fig.tight_layout()
plt.show()
plot2a_filename = 'week_5_matplotlib_lyons_2a_11JUN21.png'
...
fig.tight_layout()
plt.show()
plot2b_filename = 'week_5_matplotlib_lyons_2b_11JUN21.png'
...
fig.tight_layout()
plt.show()
plot3_filename = 'week_5_matplotlib_lyons_3_11JUN21.png'
